...
export default async function Index() {
  ...
  if (user) {
    return (
      <div className="w-full flex flex-col md:justify-center md:space-x-6 items-center m-auto">
        <>
        ...
        <Metric className='py-6 text-2xl md:text-4xl text-center'>Below you can check how expense cards work</Metric>
        <div className="w-full min-h-screen flex justify-center items-center pt-32 pb-10">
          <MockupSpendCard />
        </div>
      </div>
    )
